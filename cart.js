...
function BtnClick() {
    ...
    smallPizzaTotal.innerHTML = (smallQty * 97).toFixed(2);
    medPizzaTotal.innerHTML = (medQty * 139).toFixed(2);
    largePizzaTotal.innerHTML = (largeQty * 189).toFixed(2);
    totalCart = smallQty * 97.00 + medQty * 139.00 + largeQty * 189.00;
